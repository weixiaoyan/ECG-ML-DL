...
%------ SPECIFY DATA ------------------------------------------------------
%------ 指定数据文件 -------------------------------------------------------
PATH= 'J:\20190428-ECG\MIT-BIH\MIT-BIH\'; % 指定数据的储存路径
HEADERFILE= '234.hea';      % .hea 格式，头文件，可用记事本打开
ATRFILE= '234.atr';         % .atr 格式，属性文件，数据格式为二进制数
DATAFILE='234.dat';         % .dat 格式，ECG 数据
